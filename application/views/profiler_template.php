...
/* The location of the profiler bar. Valid locations are: - bottom-left - bottom-right - top-left - top-right - bottom - top */
...
<a href="#" id="ci-profiler-menu-open" class="<?php echo $bar_location ?>" onclick="ci_profiler_bar.open(); return false;" style="width: 2rem">&nbsp;</a>
